...
public class Artemis extends Character implements CharacterListener {//黄色
    ChooseCharacter jl;
    ...
    public Artemis(){
        ImageIcon ari = new ImageIcon("image/Artemisname1.4.png");
        setIcon(ari);
    }
    public Artemis(ChooseCharacter j) {
        jl = j;

        ImageIcon ari = new ImageIcon("image/Artemisname.png");
        setIcon(ari);
        j.add(this, new Integer(4));
        setBounds(530, 577, 100, 100);
    }
    ...
    public void clickCharacterPanel() {
        c.addMouseListener(new MouseAdapter() {
                ...
                if (jl.getPlayernumber() == 2) {
                    if (!isSelected) {
                        if (jl.getPlayer1().getColor() == null) {
                            jl.remove(c);
                            setSelected(true);
                            jl.getPlayer1().setColor(Color.YELLOW);
                            ...
                            jl.remove(c);
                            setSelected(true);
                            jl.getPlayer2().setColor(Color.YELLOW);
                        ...
                        if (!isConfirmed()) {
                            if (jl.getPlayer1().getColor() == Color.YELLOW) {
                    ...
                    if (!isSelected) {
                        if (jl.getPlayer1().getColor() == null) {
                            ...
                            jl.remove(c);
                            setSelected(true);
                            jl.getPlayer3().setColor(Color.YELLOW);
                            ...
                            jl.remove(c);
                            setSelected(true);
                            jl.getPlayer4().setColor(Color.YELLOW);
                        ...
                        if (!isConfirmed()) {
                            if (jl.getPlayer1().getColor() == Color.YELLOW) {
                                ...
                                jl.getPlayer1().setColor(null);
                                jl.getPlayer1().setCharacter(null);
                            } else if (jl.getPlayer2().getColor() == Color.YELLOW) {
                                jl.getPlayer2().remove(c);
                                setSelected(false);
                                jl.getPlayer2().setColor(null);
                                jl.getPlayer2().setCharacter(null);
                            } else if (jl.getPlayer3().getColor() == Color.YELLOW) {
                                jl.getPlayer3().remove(c);
                                setSelected(false);
                                jl.getPlayer3().setColor(null);
                                jl.getPlayer3().setCharacter(null);
                            } else if (jl.getPlayer4().getColor() == Color.YELLOW) {
            ...
            public void mouseEntered(MouseEvent e) {
                if (!isSelected) {
                    ImageIcon zeusi = new ImageIcon("image/Artemisname1.4.png");
                    setIcon(zeusi);
                    c.setBounds(515, 562, 140, 140);
            ...
            public void mouseExited(MouseEvent e) {
                if (!isSelected) {
                    ImageIcon zeusi = new ImageIcon("image/Artemisname.png");
                    setIcon(zeusi);
                    c.setBounds(530, 577, 100, 100);
                    repaint();
                }
            }
        });
