...
public class Medusa extends Character implements CharacterListener {//绿色
    ChooseCharacter jl;
    ...
    public Medusa(){
        ImageIcon mei = new ImageIcon("image/Medusaname1.4.png");
        setIcon(mei);
    }
    public Medusa(ChooseCharacter j) {
        jl = j;

        ImageIcon mei = new ImageIcon("image/Medusaname.png");
        setIcon(mei);
        j.add(this, new Integer(4));
        setBounds(180, 22, 100, 100);
    }
    ...
    public void clickCharacterPanel() {
        c.addMouseListener(new MouseAdapter() {
                ...
                if (jl.getPlayernumber() == 2) {
                    if (!isSelected) {
                        if (jl.getPlayer1().getColor() == null) {
                            jl.remove(c);
                            setSelected(true);
                            jl.getPlayer1().setColor(Color.GREEN);
                            ...
                            jl.remove(c);
                            setSelected(true);
                            jl.getPlayer2().setColor(Color.GREEN);
                        ...
                        if (!isConfirmed()) {
                            if (jl.getPlayer1().getColor() == Color.GREEN) {
                    ...
                    if (!isSelected) {
                        if (jl.getPlayer1().getColor() == null) {
                            ...
                            jl.remove(c);
                            setSelected(true);
                            jl.getPlayer3().setColor(Color.GREEN);
                            ...
                            jl.remove(c);
                            setSelected(true);
                            jl.getPlayer4().setColor(Color.GREEN);
                        ...
                        if (!isConfirmed()) {
                            if (jl.getPlayer1().getColor() == Color.GREEN) {
                                ...
                                jl.getPlayer1().setColor(null);
                                jl.getPlayer1().setCharacter(null);
                            } else if (jl.getPlayer2().getColor() == Color.GREEN) {
                                jl.getPlayer2().remove(c);
                                setSelected(false);
                                jl.getPlayer2().setColor(null);
                                jl.getPlayer2().setCharacter(null);
                            } else if (jl.getPlayer3().getColor() == Color.GREEN) {
                                jl.getPlayer3().remove(c);
                                setSelected(false);
                                jl.getPlayer3().setColor(null);
                                jl.getPlayer3().setCharacter(null);
                            } else if (jl.getPlayer4().getColor() == Color.GREEN) {
            ...
            public void mouseEntered(MouseEvent e) {
                if (!isSelected) {
                    ImageIcon zeusi = new ImageIcon("image/Medusaname1.4.png");
                    setIcon(zeusi);
                    c.setBounds(160, 3, 140, 140);
            ...
            public void mouseExited(MouseEvent e) {
                if (!isSelected) {
                    ImageIcon zeusi = new ImageIcon("image/Medusaname.png");
                    setIcon(zeusi);
                    c.setBounds(180, 22, 100, 100);
                    repaint();
                }
            }
        });
