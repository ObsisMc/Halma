...
public class Zeus extends Character implements CharacterListener {//红色
    ChooseCharacter jl;
    ...
    public Zeus(){
        ImageIcon zeusi = new ImageIcon("image/zeus4name1.4.png");
        setIcon(zeusi);
    }

    public Zeus(ChooseCharacter j) {
        jl = j;

        ImageIcon zeusi = new ImageIcon("image/zeus4name.png");
        setIcon(zeusi);
        j.add(this, new Integer(4));
        setBounds(355, 580, 100, 100);
    }

    public Zeus(GameFrame gf) {
                ...
                if (jl.getPlayernumber() == 2) {
                    if (!isSelected) {
                        if (jl.getPlayer1().getColor() == null) {
                            jl.remove(c);
                            setSelected(true);
                            jl.getPlayer1().setColor(Color.RED);
                            ...
                            jl.remove(c);
                            setSelected(true);
                            jl.getPlayer2().setColor(Color.RED);
                        ...
                        if (!isConfirmed()) {
                            if (jl.getPlayer1().getColor() == Color.RED) {
                    ...
                    if (!isSelected) {
                        if (jl.getPlayer1().getColor() == null) {
                            ...
                            jl.remove(c);
                            setSelected(true);
                            jl.getPlayer3().setColor(Color.RED);
                            ...
                            jl.remove(c);
                            setSelected(true);
                            jl.getPlayer4().setColor(Color.RED);
                        ...
                        if (!isConfirmed()) {
                            if (jl.getPlayer1().getColor() == Color.RED) {
                                ...
                                jl.getPlayer1().setColor(null);
                                jl.getPlayer1().setCharacter(null);
                            } else if (jl.getPlayer2().getColor() == Color.RED) {
                                jl.getPlayer2().remove(c);
                                setSelected(false);
                                jl.getPlayer2().setColor(null);
                                jl.getPlayer2().setCharacter(null);
                            } else if (jl.getPlayer3().getColor() == Color.RED) {
                                jl.getPlayer3().remove(c);
                                setSelected(false);
                                jl.getPlayer3().setColor(null);
                                jl.getPlayer3().setCharacter(null);
                            } else if (jl.getPlayer4().getColor() == Color.RED) {
